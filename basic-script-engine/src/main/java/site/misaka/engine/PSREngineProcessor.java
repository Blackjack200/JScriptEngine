...
public abstract class PSREngineProcessor<FT extends ScriptEngineFactory, ET extends EngineAdapter> extends IEngineProcessor<ET> {
	protected FT factory;
	protected Vector<ET> engineList = new Vector<>();

	public PSREngineProcessor(FT factory) {
